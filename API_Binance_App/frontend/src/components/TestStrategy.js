...
const TestStrategy = ({ selectedStrategy, onCancel, username }) => {
  ...
  return (
    <div className="test-strategy-modal">
      {selectedStrategy && (
        <>
          <h4>Testuj Strategię: {selectedStrategy.name}</h4>
          ...
          <div className="strategy-params">
            ...
            <p>Para: {selectedStrategy.pair}</p>
            <p>Interval: {selectedStrategy.time_frame}</p>
            <p>SMA Short: {selectedStrategy.short_window}</p>
            <p>SMA Long: {selectedStrategy.long_window}</p>
            <p>Stop Loss: {selectedStrategy.stop_loss_percentage}</p>
            <p>RSI Period: {selectedStrategy.rsi_period}</p>
            <p>Kwota transakcji: {selectedStrategy.trade_amount}</p>
          </div>
